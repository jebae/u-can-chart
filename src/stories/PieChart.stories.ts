...
export const Simple: Story = {
	args: {
		...
		height: 400,
		data: [
			{ label: 'Melon', value: 30, color: '#7400b8' },
			{ label: 'Grape', value: 30, color: '#5e60ce' },
			{ label: 'Tomato', value: 20, color: '#4ea8de' },
			{ label: 'Orange', value: 15, color: '#56cfe1' },
			{ label: 'Banana', value: 10, color: '#64dfdf' },
			{ label: 'Apple', value: 5, color: '#80ffdb' },
		],
		innerRadius: 0,
